...
# https://github.com/usemailman/mailman/blob/main/docs/development.md
...
go build -o ./build/mailman.exe ./main.go
...
Write-Host "You can test the build with ./build/mailman.exe --mode demo" -f Green
